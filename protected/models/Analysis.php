...
class Analysis extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idAnalysis, idCustomer, idUser', 'required'),
			array('idAnalysis, idCustomer, idUser', 'numerical', 'integerOnly'=>true),
			array('Comments', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idAnalysis, idCustomer, idUser, Comments', 'safe', 'on'=>'search'),
		);
	}
